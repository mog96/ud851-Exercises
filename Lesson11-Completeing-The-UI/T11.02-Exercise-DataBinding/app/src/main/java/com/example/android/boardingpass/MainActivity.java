...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        mBinding.textViewDestinationAirport.setText(info.originCode);
        ...
        String formattedTimeUntilBoarding = String.format(Locale.getDefault(), "%1$02d:%2$02d", hoursUntilBoarding, minutesUntilBoarding);
        mBinding.textViewBoardingInCountdown.setText(formattedTimeUntilBoarding);
    }
}
