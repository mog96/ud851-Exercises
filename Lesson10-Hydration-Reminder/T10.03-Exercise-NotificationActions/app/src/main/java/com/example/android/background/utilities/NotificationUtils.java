...
public class NotificationUtils {
    ...
    private static final int ACTION_DRINK_WATER_PENDING_INTENT_ID = 1113;
    ...
    public static NotificationCompat.Action ignoreReminderAction(Context context) {
        Intent service = new Intent(context, WaterReminderIntentService.class);
        service.setAction(ReminderTasks.ACTION_DISMISS_NOTIFICATION);
